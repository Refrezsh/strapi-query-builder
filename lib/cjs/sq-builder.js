...
class SQBuilder {
    constructor(builderConfig) {
        ...
        if (builderConfig) {
            this._builderConfig = Object.assign(Object.assign({}, this._builderConfig), builderConfig);
        }
    }
    ...
    on(componentTypeKey, nestedCallback) {
        ...
        const populationIndex = (0, lodash_1.findIndex)(this._query.population, (p) => p.key === this._prevPopulateKey);
        const nestedBuilder = new SQBuilder({
            defaultSort: this._builderConfig.defaultSort,
        });
        nestedCallback(nestedBuilder);
        const newQuery = {};
        (0, lodash_1.assign)(newQuery, {
            [componentTypeKey]: {
                fields: nestedBuilder.getRawFields(),
                population: nestedBuilder.getRawPopulation(),
                sort: nestedBuilder.getRawSort(),
        ...
        if (populationIndex === -1) {
            ...
            this._query.population[populationIndex] = {
                key: this._prevPopulateKey,
                nestedQuery: Object.assign(Object.assign({}, populationQuery.nestedQuery), newQuery),
            };
        }
        return this;
    }
    _addToPopulate(populate) {
        ...
        const founded = (0, lodash_1.findIndex)(this._query.population, (f) => {
    ...
    sort(sortQuery) {
        ...
        this._query.sort = (0, lodash_1.unionBy)(Array.isArray(nowSortValue) ? nowSortValue : [nowSortValue], Array.isArray(parsedSortQuery) ? parsedSortQuery : [parsedSortQuery], (v) => v.key);
        return this;
    }
    ...
    page(page) {
        ...
        this._query.pagination = Object.assign(Object.assign({}, this._query.pagination), { page });
        return this;
    }
    pageSize(pageSize) {
        if (this._isReadonly) {
        ...
        this._query.pagination = Object.assign(Object.assign({}, this._query.pagination), { pageSize });
        return this;
    }
    pageStart(start) {
        if (this._isReadonly) {
        ...
        this._query.offsetPagination = Object.assign(Object.assign({}, this._query.offsetPagination), { start });
        return this;
    }
    pageLimit(limit) {
        if (this._isReadonly) {
        ...
        this._query.offsetPagination = Object.assign(Object.assign({}, this._query.offsetPagination), { limit });
        return this;
    }
    // </editor-fold>
    ...
    joinPopulation(builder) {
        ...
        this._query.population = (0, lodash_1.unionBy)(this._query.population, externalPopulation, (p) => p.key);
        return this;
    }
    /**
    ...
    joinSort(builder) {
        ...
        this._query.sort = (0, lodash_1.unionBy)(this._query.sort, externalSort, (s) => s.key);
        return this;
    }
    /**
    ...
    static _parsePopulate(populates, queryType = "strapiService") {
        ...
        for (const populate of populates) {
            ...
            if (isComplex) {
                ...
                if (isDefaultQuery) {
                    (0, lodash_1.assign)(parsedPopulates, {
                ...
                (0, lodash_1.assign)(parsedPopulates, { [populate.key]: true });
            }
        }
